...
#
# 1. Build the image with: docker build --no-cache -t test/karibu10-helloworld-application-maven:latest .
# 2. Run the image with: docker run --rm -ti -p8080:8080 test/karibu10-helloworld-application-maven
#
